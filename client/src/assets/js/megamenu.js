jQuery(document).ready(function($) {
    $.fn.et_menu = function(options) {
            ...
            openOnClick: function(el, e) {
                ...
                if ($this.parent().hasClass(openedClass)) {
                    ...
                    setTimeout(function() {
                        ...
                        header.stop().animate({
                            'paddingBottom': $this.next().height() + 50
                        }, settings.animTime);
        ...
        this.find('>li').hover(function() {
            ...
            if (!$(this).hasClass('open-by-click') || (!settings.openByClick && $(this).hasClass('open-by-click'))) {
                ...
                $(el).addClass("loading").delay(settings.delayTime).fadeOut(100, function() {
                    $(el).removeClass("loading")
                });
            }
        });
    ...
    $('.menu-icon, .close-mobile-nav, .header-container.type10 .dropdown-menu > .menu-container > a').click(function(event) {
        if (!$('body').hasClass('md-mobile-menu') && ($(".header-container").hasClass('type11') || $(".header-container").hasClass('type13') || $(".header-container").hasClass('type7'))) $('body').addClass('md-mobile-menu');
